...
export default function PagePengumpulanTugasKader() {
      ...
      if (user) {
        ...
        const unsubRole = onSnapshot(qRole, (snapRole: any) => {
          if (!snapRole.empty) {
            ...
            // Ambil daftar judul tugas yang disediakan Instansi (Komisariat & Rayon asal)
            ...
            // Ambil histori file yang pernah dikumpulkan kader ini
  ...
  const handleUploadTugas = async (e: React.FormEvent) => {
    ...
    // Cek apakah sudah pernah upload tugas dengan judul ini dan belum disetujui (opsional)
